...
public class FroggerComponent extends JComponent implements KeyListener, Runnable {
    ...
    private double highscore = readPreference();
    ...
    public void update() throws InterruptedException {
        ...
        if (engine.getState() == FroggerState.WON) {
            level++;
            score += round(PlayFrogger.scorePerSeconds(), 1);
        ...
        if (level == 0) {
            ...
            PlayFrogger.lab3.setText("SCORE: " + Double.toString(score));
...
//		}
    ...
    private void checkHighscore() {
        ...
        PlayFrogger.lab4.setText("HIGHSCORE: " + Double.toString(highscore));
...
//        PlayFrogger.lab4.setForeground(Color.RED);
    ...
    public void savePreference(double highscore) {
        Preferences prefs = Preferences.userNodeForPackage(FroggerComponent.class);

        prefs.putDouble(HIGHSCORE, highscore);
    }

    public double readPreference() {
        Preferences prefs = Preferences.userNodeForPackage(FroggerComponent.class);
